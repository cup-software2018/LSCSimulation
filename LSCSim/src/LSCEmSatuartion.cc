...
// ********************************************************************
//
// $Id: LSCEmSatuartion.cc,v 1.1.1.1 2018/04/16 04:22:51 cupsoft Exp $
//
// -------------------------------------------------------------------
//
// GEANT4 Class file
  ...
  G4double niel)
{
  ...
  G4double bfactor1 = 0.12;
  G4double bfactor2 = 0.002;
...
G4double LSCEmSaturation::FindG4BirksCoefficient(const G4Material * mat)
{
...
G4double LSCEmSaturation::FindBirksCoefficient(const G4Material * mat)
{
...
void LSCEmSaturation::DumpBirksCoefficients()
{
  if (nMaterials > 0) {
...
void LSCEmSaturation::DumpG4BirksCoefficients()
{
  if (nG4Birks > 0) {
...
void LSCEmSaturation::Initialise()
{
