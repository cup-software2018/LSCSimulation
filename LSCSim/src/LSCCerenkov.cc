...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* LSCCerenkov::PostStepDoIt(const G4Track& aTrack,
                                            const G4Step& aStep)
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void LSCCerenkov::PreparePhysicsTable(const G4ParticleDefinition&)
{
  Initialise();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double LSCCerenkov::GetMeanFreePath(const G4Track&, G4double,
                                     G4ForceCondition*)
{
  return 1.;
}
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double LSCCerenkov::PostStepGetPhysicalInteractionLength(
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double LSCCerenkov::GetAverageNumberOfPhotons(
...
void LSCCerenkov::SetNewValue(G4UIcommand * command, G4String newValues)
{
  if (command == fCerenkovOnCmd) {
    ...
    is >> fIsCerenkovOn;
    if (fIsCerenkovOn == 0) {
      G4cout << "LSCCerenkov::Cerenkov will be turned off" << G4endl;
    }
  }
}