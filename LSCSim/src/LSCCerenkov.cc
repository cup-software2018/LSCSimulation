...
LSCCerenkov::LSCCerenkov(const G4String & processName, G4ProcessType type)
    ...
    fNumPhotons(0)
{
  ...
  fCerenkovDir = new G4UIdirectory("/LSC/Cerenkov/");
  fCerenkovOnCmd = new G4UIcmdWithAString("/LSC/Cerenkov/cerenkovon", this);

  fIsCerenkovOn = 1;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
LSCCerenkov::~LSCCerenkov()
{
...
void LSCCerenkov::ProcessDescription(std::ostream & out) const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool LSCCerenkov::IsApplicable(const G4ParticleDefinition & aParticleType)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void LSCCerenkov::BuildPhysicsTable(const G4ParticleDefinition &)
{
        ...
        if (currentRI > 1.0) {
          ...
          for (std::size_t ii = 1; ii < refractiveIndex->GetVectorLength(); ++ii) {
            ...
            currentCAI = prevCAI + (currentPM - prevPM) * 0.5 *
                                       (1.0 / (prevRI * prevRI) + 1.0 / (currentRI * currentRI));
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange * LSCCerenkov::PostStepDoIt(const G4Track & aTrack, const G4Step & aStep)
...

{
  ...
  if (verboseLevel > 1) {
    G4cout << "\n Exiting from LSCCerenkov::DoIt -- NumberOfSecondaries = "
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void LSCCerenkov::PreparePhysicsTable(const G4ParticleDefinition &) { Initialise(); }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double LSCCerenkov::GetMeanFreePath(const G4Track &, G4double, G4ForceCondition *) { return 1.; }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double LSCCerenkov::PostStepGetPhysicalInteractionLength(const G4Track & aTrack, G4double,
                                                           G4ForceCondition * condition)
{
  *condition = NotForced;
  ...
  G4double nMax;
  if (Rindex) { nMax = Rindex->GetMaxValue(); }
  else {
    return StepLimit;
  }
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double LSCCerenkov::GetAverageNumberOfPhotons(const G4double charge, const G4double beta,
...
// Geant4-unit (millimeter) in the current medium.
{
  ...
  // the Value() method of G4PhysicsVector.
    ...
    if (verboseLevel > 1) { G4cout << "CAImin = " << CAImin << G4endl << "ge = " << ge << G4endl; }
  }
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void LSCCerenkov::SetTrackSecondariesFirst(const G4bool state)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void LSCCerenkov::SetMaxBetaChangePerStep(const G4double value)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void LSCCerenkov::SetMaxNumPhotonsPerStep(const G4int NumPhotons)
{
  fMaxPhotons = NumPhotons;
  G4OpticalParameters::Instance()->SetCerenkovMaxPhotonsPerStep(fMaxPhotons);
}

void LSCCerenkov::SetStackPhotons(const G4bool stackingFlag)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void LSCCerenkov::DumpPhysicsTable() const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void LSCCerenkov::SetVerboseLevel(G4int verbose)
{
  verboseLevel = verbose;
  G4OpticalParameters::Instance()->SetCerenkovVerboseLevel(verboseLevel);
}

void LSCCerenkov::SetNewValue(G4UIcommand * command, G4String newValues)
{
  if (command == fCerenkovOnCmd) {
    istringstream is((const char *)newValues);
    is >> fIsCerenkovOn;
    if (fIsCerenkovOn == 0) { G4cout << "LSCCerenkov::Cerenkov will be turned off" << G4endl; }
  }
}