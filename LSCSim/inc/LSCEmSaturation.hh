...
// ********************************************************************
//
// $Id: LSCEmSaturation.hh,v 1.1.1.1 2018/04/16 04:22:51 cupsoft Exp $
//
//
#ifndef LSCEmSaturation_h
#define LSCEmSaturation_h 1
...
class LSCEmSaturation {
public:

  LSCEmSaturation();
  virtual ~LSCEmSaturation();
...
private:
  ...
  LSCEmSaturation & operator=(const LSCEmSaturation & right);
  LSCEmSaturation(const LSCEmSaturation &);
...
inline void LSCEmSaturation::SetVerbose(G4int val)
{
  verbose = val;
}

inline G4double LSCEmSaturation::VisibleEnergyDeposition(
  const G4Step * step)
{
