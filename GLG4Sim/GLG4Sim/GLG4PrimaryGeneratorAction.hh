...
public:
  ...
  int GetTypeOfCurrentEvent()
  { return myTypeOfCurrentEvent; }
  ...
  enum { kGunEvtIndex=3, kGunPosIndex=9, kGunVtxIndex=17,
         kDelayEvtIndex=51, kDelayPosIndex=12, kDelayVtxIndex=19 };
  enum { theNumEventTypes = 52,
         theNumPosGenCodes = 13,
         theNumVertexGenCodes= 20 };
  enum { kGeneratorTriggerNormal=0, kGeneratorTriggerPileupOnly=1,
...
private:
  ...
  typedef struct codepair_s { int poscode, vertexcode; } codepair_t;
