/** @file GLG4HitPMT.cc
    ...
    $Id: GLG4HitPMT.cc,v 1.2 2013/11/11 02:39:17 jslee Exp $
...
const size_t GLG4HitPMT::kApproxMaxIndividualHitPhotonsPerPMT = 100;
...
void GLG4HitPMT::DetectPhoton(GLG4HitPhoton * new_photon){
  if(fPhotons.size() < kApproxMaxIndividualHitPhotonsPerPMT)
    ...
    it2 = lower_bound(fPhotons.begin(), fPhotons.end(), new_photon, Compare_HitPhotonPtr_TimeAscending);
    it1 = it2;
